...
@section('content')
<h4 class="text-primary text-center"><i class="fa fa-edit"></i> @yield('pageTitle') | {{ $donatur->dona_nama }}</h4>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <select class="form-control" id="inputKab" name="inputKab">
                    <option value="Kab. Bandung" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Bandung' ? 'selected' : ''  }}>Kab. Bandung</option>
                    <option value="Kab. Bandung Barat" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Bandung Barat' ? 'selected' : ''  }}>Kab. Bandung Barat</option>
                    <option value="Kab. Bekasi" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Bekasi' ? 'selected' : ''  }}>Kab. Bekasi</option>
                    <option value="Kab. Bogor" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Bogor' ? 'selected' : ''  }}>Kab. Bogor</option>
                    <option value="Kab. Ciamis" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Ciamis' ? 'selected' : ''  }}>Kab. Ciamis</option>
                    <option value="Kab. Cianjur" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Cianjur' ? 'selected' : ''  }}>Kab. Cianjur</option>
                    <option value="Kab. Cirebon" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Cirebon' ? 'selected' : ''  }}>Kab. Cirebon</option>
                    <option value="Kab. Garut" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Garut' ? 'selected' : ''  }}>Kab. Garut</option>
                    <option value="Kab. Indramayu" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Indramayu' ? 'selected' : ''  }}>Kab. Indramayu</option>
                    <option value="Kab. Karawang" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Karawang' ? 'selected' : ''  }}>Kab. Karawang</option>
                    <option value="Kab. Kuningan" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Kuningan' ? 'selected' : ''  }}>Kab. Kuningan</option>
                    <option value="Kab. Majalengka" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Majalengka' ? 'selected' : ''  }}>Kab. Majalengka</option>
                    <option value="Kab. Pangandaran" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Pangandaran' ? 'selected' : ''  }}>Kab. Pangandaran</option>
                    <option value="Kab. Purwakarta" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Purwakarta' ? 'selected' : ''  }}>Kab. Purwakarta</option>
                    <option value="Kab. Subang" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Subang' ? 'selected' : ''  }}>Kab. Subang</option>
                    <option value="Kab. Sukabumi" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Sukabumi' ? 'selected' : ''  }}>Kab. Sukabumi</option>
                    <option value="Kab. Sumedang" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Sumedang' ? 'selected' : ''  }}>Kab. Sumedang</option>
                    <option value="Kab. Tasikmalaya" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kab. Tasikmalaya' ? 'selected' : ''  }}>Kab. Tasikmalaya</option>
                    <option value="Kota Bandung" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kota Bandung' ? 'selected' : ''  }}>Kota Bandung</option>
                    <option value="Kota Banjar" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kota Banjar' ? 'selected' : ''  }}>Kota Banjar</option>
                    <option value="Kota Bekasi" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kota Bekasi' ? 'selected' : ''  }}>Kota Bekasi</option>
                    <option value="Kota Bogor" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kota Bogor' ? 'selected' : ''  }}>Kota Bogor</option>
                    <option value="Kota Cimahi" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kota Cimahi' ? 'selected' : ''  }}>Kota Cimahi</option>
                    <option value="Kota Cirebon" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kota Cirebon' ? 'selected' : ''  }}>Kota Cirebon</option>
                    <option value="Kota Depok" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kota Depok' ? 'selected' : ''  }}>Kota Depok</option>
                    <option value="Kota Sukabumi" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kota Sukabumi' ? 'selected' : ''  }}>Kota Sukabumi</option>
                    <option value="Kota Tasikmalaya" {{ old('inputKab', $donatur['dona_kota_kab'] )== 'Kota Tasikmalaya' ? 'selected' : ''  }}>Kota Tasikmalaya</option>
                </select>
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-5">
                <div class="form-group col-md-12">
                    ...
                    <textarea style="min-height: 125px;" class="form-control" id="inputCatatan" name="inputCatatan" maxlength="150" placeholder="Maksimum 150 karakter...">{{ $donatur->dona_catatan }}</textarea>
                </div>
            </div>
        </div>
